            ...
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="post__content">                      
                        ...
                        <div class="post__content-info">
                                <div class="widget w-tags">
                                        <div class="tags-wrap">     
                                            <a href="{{route('catalogue')}}">Get Item</a>
                                      {{-- <a href="{{route('product.single',['id'=>$post->product_id])}}" class="w-tags-item">Get Item</a>--}}
                                    </div>
                                </div>
                            {!! $post->content !!}
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-content">
                        ...
                        <p class="text">All information regarding this post is verified at {{$post->updated_at->toFormattedDateString()}}
                        </p>
                        <br>
                        <br>
                    </div>
            ...
            <div class="col-lg-12">
                <aside aria-label="sidebar" class="sidebar sidebar-right">
                    <div  class="widget w-tags">
                        ...
                        <div class="tags-wrap">
                             @foreach($tags as $tag)
                            <a href="{{route('category.single',['id'=>$post->category])}}" class="w-tags-item">{{$tag->tag}}</a>
                              @endforeach
                        </div>
                    </div>
                </aside>
