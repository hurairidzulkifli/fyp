            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">This website is created for my Final Year Project 
                             presentation and it is available in both web & mobile application.
                        </p>
                    </div>
                </div>
            </div>
